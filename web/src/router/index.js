...
const mainRoutes = {
  ...
  children: [
    ...
    {
      path: '/report',
      component: _import('menus/report'),
      name: 'report',
      meta: { title: '报表', isTab: true }
    },
    {
      path: '/mechanism',
      component: _import('menus/mechanism'),
      name: 'mechanism',
      meta: { title: '机构维护', isTab: true }
    },
    {
      path: '/project',
      component: _import('menus/project'),
      name: 'project',
      meta: { title: '项目维护', isTab: true }
    },
    {
      path: '/weights',
      component: _import('menus/weights'),
      name: 'weights',
      meta: { title: '权重维护', isTab: true }
    }
  ]
