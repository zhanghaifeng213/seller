    ...
    <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          <el-button  type="text" size="small" @click="addOrUpdateHandle(scope.row.userId)">权重设置</el-button>
...
<script>
import AddOrUpdate from './weights-add-or-update'
export default {
  data() {
    return {
      dataForm: {
